...
const lookupTokenMetadata = async (policyId, assetName, network) => {
...
const formatToken = ({ decimals, ticker, name }, value) => `${value * 10 ** -(decimals || 0)} ${ticker || name}`;

exports.formatToken = formatToken;
exports.lookupTokenMetadata = lookupTokenMetadata;
