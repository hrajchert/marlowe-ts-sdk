...
(function (exports) {
	var __extends = (Either.commonjsGlobal && Either.commonjsGlobal.__extends) || (function () {
	...
	var __assign = (Either.commonjsGlobal && Either.commonjsGlobal.__assign) || function () {
	...
	var __spreadArray = (Either.commonjsGlobal && Either.commonjsGlobal.__spreadArray) || function (to, from, pack) {
...
const datetoIso8601 = (date) => Either._function.pipe(date, (date) => format(date, "yyyy-MM-dd'T'HH:mm:ss'Z'"));
const datetoIso8601Bis = (date) => Either._function.pipe(date, formatISO);
...
exports.datetoIso8601Bis = datetoIso8601Bis;
exports.time = time;
