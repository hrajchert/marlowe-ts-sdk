import { _ as _function, A as Apply, C as Chain, c as commonjsGlobal, E as Either, g as getDefaultExportFromCjs } from './Either-d9970dbd.js';
...
Object.defineProperty(DecodeError, "__esModule", { value: true });
DecodeError.getSemigroup = DecodeError.fold = DecodeError.wrap = DecodeError.lazy = DecodeError.member = DecodeError.index = DecodeError.key = DecodeError.leaf = DecodeError.optional = DecodeError.required = void 0;
var FS = __importStar$1(FreeSemigroup);
/**
 * @category model
 * @since 2.2.7
 */
// eslint-disable-next-line @typescript-eslint/prefer-as-const
DecodeError.required = 'required';
/**
 * @category model
 * @since 2.2.7
 */
// eslint-disable-next-line @typescript-eslint/prefer-as-const
DecodeError.optional = 'optional';
/**
 * @category constructors
 * @since 2.2.7
 */
var leaf = function (actual, error) { return ({ _tag: 'Leaf', actual: actual, error: error }); };
DecodeError.leaf = leaf;
/**
 * @category constructors
 * @since 2.2.7
 */
...
DecodeError.member = member;
/**
 * @category constructors
 * @since 2.2.7
 */
var lazy$1 = function (id, errors) { return ({
    _tag: 'Lazy',
    id: id,
    errors: errors
}); };
DecodeError.lazy = lazy$1;
/**
 * @category constructors
 * @since 2.2.9
 */
...
DecodeError.getSemigroup = getSemigroup;

var Guard = {};

var Schemable = {};

Object.defineProperty(Schemable, "__esModule", { value: true });
Schemable.intersect_ = Schemable.memoize = void 0;
/**
 * @since 2.2.0
 */
function memoize(f) {
...
Schemable.intersect_ = intersect_;
...
Object.defineProperty(Kleisli, "__esModule", { value: true });
Kleisli.alt = Kleisli.map = Kleisli.id = Kleisli.compose = Kleisli.lazy = Kleisli.fromSum = Kleisli.intersect = Kleisli.union = Kleisli.fromTuple = Kleisli.fromRecord = Kleisli.fromArray = Kleisli.fromPartial = Kleisli.fromType = Kleisli.fromStruct = Kleisli.nullable = Kleisli.parse = Kleisli.refine = Kleisli.mapLeftWithInput = Kleisli.literal = Kleisli.fromRefinement = void 0;
...
Kleisli.fromRefinement = fromRefinement;
/**
 * @category constructors
 * @since 2.2.7
 */
...
Kleisli.mapLeftWithInput = mapLeftWithInput;
/**
 * @category combinators
 * @since 2.2.7
 */
...
Kleisli.fromPartial = fromPartial;
/**
 * @category combinators
 * @since 2.2.7
 */
...
(function (exports) {
	...
	var function_1 = _function;
	var pipeable_1 = pipeable$1;
	var D = __importStar(Decoder);
	var E = __importStar(Encoder);
	// -------------------------------------------------------------------------------------
	// constructors
	// -------------------------------------------------------------------------------------
	/**
...
var JSONbigint = /*@__PURE__*/getDefaultExportFromCjs(jsonBigintExports);

const MarloweJSON = JSONbigint({
    alwaysParseAsBig: true,
    useNativeBigInt: true,
});
const MarloweJSONDecoder = {
    decode: (data) => (data === "" ? null : MarloweJSON.parse(data)),
};
const MarloweJSONEncoder = {
    encode: (data) => MarloweJSON.stringify(data),
};
const MarloweJSONCodec = Codec.make(MarloweJSONDecoder, MarloweJSONEncoder);
const minify = (a) => a.replace(/[\n\r\s]/g, "");

var codec = /*#__PURE__*/Object.freeze({
    __proto__: null,
    MarloweJSON: MarloweJSON,
    MarloweJSONCodec: MarloweJSONCodec,
    MarloweJSONDecoder: MarloweJSONDecoder,
    MarloweJSONEncoder: MarloweJSONEncoder,
    minify: minify
});

export { MarloweJSON as M, MarloweJSONDecoder as a, MarloweJSONEncoder as b, codec as c, MarloweJSONCodec as d, minify as m };
