...
var index$2 = require('./index-040eb70b.cjs');
 ...
 * @internal
 */
var isNonEmpty$3 = index$2.isNonEmpty;
/**
 * @internal
 */
...
var unsafeUpdateAt$4 = function (i, a, as) {
    if (as[i] === a) {
        ...
        var xs = index$2.fromReadonlyNonEmptyArray(as);
        xs[i] = a;
        return xs;
    }
};
...
var intersperse$2 = function (middle) {
    return function (as) {
        var rest = tail$2(as);
        return isNonEmpty$3(rest) ? index$2.pipe(rest, prependAll$2(middle), prepend$2(head$3(as))) : as;
    };
};
/**
 * @category folding
...
var intercalate$3 = function (S) {
    ...
    return function (middle) { return index$2.flow(intersperse$2(middle), concatAllS); };
};
...
var union$2 = function (E) {
    var uniqE = uniq$1(E);
    return function (second) { return function (first) { return uniqE(index$2.pipe(first, concat$1(second))); }; };
};
/**
...
var rotate$1 = function (n) {
    return function (as) {
        ...
        if (m < 0) {
            ...
            return index$2.pipe(s, concat$1(f));
        }
        else {
 ...
 * @since 2.10.0
 */
var fromReadonlyNonEmptyArray = index$2.fromReadonlyNonEmptyArray;
/**
 ...
 * @since 2.0.0
 */
var fromArray = function (as) { return (isNonEmpty$2(as) ? index$2.some(as) : index$2.none); };
/**
...
var insertAt$2 = function (i, a) {
    return function (as) {
        return i < 0 || i > as.length ? index$2.none : index$2.some(unsafeInsertAt$1(i, a, as));
    };
};
/**
 * @since 2.0.0
...
var modifyAt$1 = function (i, f) {
    return function (as) {
        return isOutOfBound$2(i, as) ? index$2.none : index$2.some(unsafeUpdateAt$3(i, f(as[i]), as));
    };
};
/**
 * @since 2.0.0
...
var intersperse$1 = function (middle) {
    return function (as) {
        var rest = tail$1(as);
        return isNonEmpty$2(rest) ? index$2.pipe(rest, prependAll$1(middle), prepend$1(head$2(as))) : copy$1(as);
    };
};
/**
 * @category folding
...
var splitAt$1 = function (n) {
    return function (as) {
        var m = Math.max(1, n);
        return m >= as.length ? [copy$1(as), []] : [index$2.pipe(as.slice(1, m), prepend$1(head$2(as))), as.slice(m)];
    };
};
/**
 * @since 2.10.0
...
var _map$3 = function (fa, f) { return index$2.pipe(fa, map$3(f)); };
/* istanbul ignore next */
var _mapWithIndex$2 = function (fa, f) { return index$2.pipe(fa, mapWithIndex$2(f)); };
/* istanbul ignore next */
var _ap$1 = function (fab, fa) { return index$2.pipe(fab, ap$1(fa)); };
/* istanbul ignore next */
var _extend$1 = function (wa, f) { return index$2.pipe(wa, extend$1(f)); };
/* istanbul ignore next */
var _reduce$2 = function (fa, b, f) { return index$2.pipe(fa, reduce$3(b, f)); };
/* istanbul ignore next */
var _foldMap$2 = function (M) {
    var foldMapM = foldMap$3(M);
    return function (fa, f) { return index$2.pipe(fa, foldMapM(f)); };
};
/* istanbul ignore next */
var _reduceRight$2 = function (fa, b, f) { return index$2.pipe(fa, reduceRight$3(b, f)); };
/* istanbul ignore next */
var _traverse$2 = function (F) {
    var traverseF = traverse$3(F);
    return function (ta, f) { return index$2.pipe(ta, traverseF(f)); };
};
/* istanbul ignore next */
var _alt$1 = function (fa, that) { return index$2.pipe(fa, alt$1(that)); };
/* istanbul ignore next */
var _reduceWithIndex$2 = function (fa, b, f) {
    return index$2.pipe(fa, reduceWithIndex$3(b, f));
};
/* istanbul ignore next */
var _foldMapWithIndex$2 = function (M) {
    var foldMapWithIndexM = foldMapWithIndex$3(M);
    return function (fa, f) { return index$2.pipe(fa, foldMapWithIndexM(f)); };
};
/* istanbul ignore next */
var _reduceRightWithIndex$2 = function (fa, b, f) {
    return index$2.pipe(fa, reduceRightWithIndex$3(b, f));
};
/* istanbul ignore next */
var _traverseWithIndex$2 = function (F) {
    var traverseWithIndexF = traverseWithIndex$2(F);
    return function (ta, f) { return index$2.pipe(ta, traverseWithIndexF(f)); };
};
/**
...
var altW$1 = function (that) {
    return function (as) {
        return index$2.pipe(as, concatW$1(that()));
    };
};
/**
...
var ap$1 = function (as) {
    return flatMap$1(function (f) { return index$2.pipe(as, map$3(f)); });
};
/**
 * @example
 * import * as NEA from 'fp-ts/NonEmptyArray'
 ...
 * @since 2.14.0
 */
var flatMap$1 = /*#__PURE__*/ index$2.dual(2, function (ma, f) {
    return index$2.pipe(ma, chainWithIndex$1(function (i, a) { return f(a, i); }));
});
/**
 * @since 2.0.0
 */
 ...
 * @since 2.5.0
 */
var duplicate$1 = /*#__PURE__*/ extend$1(index$2.identity);
/**
 * @category sequencing
 * @since 2.5.0
 */
var flatten$1 = /*#__PURE__*/ flatMap$1(index$2.identity);
/**
...
var traverseWithIndex$2 = function (F) {
    return function (f) {
        return function (as) {
            ...
            for (var i = 1; i < as.length; i++) {
                out = F.ap(F.map(out, function (bs) { return function (b) { return index$2.pipe(bs, append$1(b)); }; }), f(i, as[i]));
            }
            return out;
        };
    };
 ...
 * @since 2.10.0
 */
var flap$1 = /*#__PURE__*/ index$2.flap(Functor$1);
/**
 * @category instances
 * @since 2.10.0
 */
 ...
 * @since 2.5.0
 */
var apFirst$1 = /*#__PURE__*/ index$2.apFirst(Apply$1);
/**
 * Combine two effectful actions, keeping only the result of the second.
 *
 * @since 2.5.0
 */
var apSecond$1 = /*#__PURE__*/ index$2.apSecond(Apply$1);
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 */
var chainFirst$1 = 
/*#__PURE__*/ index$2.chainFirst(Chain$1);
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 * @since 2.9.0
 */
var Do$1 = /*#__PURE__*/ of$1(index$2.emptyRecord);
/**
 * @category do notation
 * @since 2.8.0
 */
var bindTo$1 = /*#__PURE__*/ index$2.bindTo(Functor$1);
var let_$1 = /*#__PURE__*/ index$2.let_(Functor$1);
/**
 * @category do notation
 * @since 2.8.0
 */
var bind$1 = /*#__PURE__*/ index$2.bind(Chain$1);
/**
 * @category do notation
 * @since 2.8.0
 */
var apS$1 = /*#__PURE__*/ index$2.apS(Apply$1);
// -------------------------------------------------------------------------------------
// utils
// -------------------------------------------------------------------------------------
/**
...
var modifyLast = function (f) {
    return function (as) {
        return index$2.pipe(init$1(as), append$1(f(last$2(as))));
    };
};
/**
...
function cons$1(head, tail) {
    return tail === undefined ? prepend$1(head) : index$2.pipe(tail, prepend$1(head));
}
/**
 ...
 * @deprecated
 */
var snoc$1 = function (init, end) { return index$2.pipe(init, append$1(end)); };
/**
...
function lookup$2(i, as) {
    return as === undefined ? function (as) { return lookup$2(i, as); } : isOutOfBound$1(i, as) ? index$2.none : index$2.some(as[i]);
}
/**
 ...
 * @since 2.5.0
 */
var head$1 = function (as) { return (isNonEmpty$1(as) ? index$2.some(head$3(as)) : index$2.none); };
/**
 ...
 * @since 2.5.0
 */
var last$1 = function (as) { return (isNonEmpty$1(as) ? index$2.some(last$3(as)) : index$2.none); };
/**
...
/** @internal */
var _chainRecDepthFirst$1 = function (a, f) { return index$2.pipe(a, chainRecDepthFirst$1(f)); };
/** @internal */
var _chainRecBreadthFirst$1 = function (a, f) { return index$2.pipe(a, chainRecBreadthFirst$1(f)); };
/**
 * @category folding
 * @since 2.5.0
 */
...
var getOrd$1 = function (O) {
    return index$2.fromCompare(function (a, b) {
        var aLen = a.length;
        var bLen = b.length;
 ...
 * @since 2.11.0
 */
var fromOption = function (ma) { return (index$2.isNone(ma) ? [] : [ma.value]); };
/**
 ...
 * @since 2.11.0
 */
var fromEither = function (e) { return (index$2.isLeft(e) ? [] : [e.right]); };
/**
 * Less strict version of [`match`](#match).
 *
 * The `W` suffix (short for **W**idening) means that the handler return types will be merged.
 ...
 * @since 2.0.0
 */
var tail = function (as) { return (isNonEmpty(as) ? index$2.some(tail$1(as)) : index$2.none); };
/**
 ...
 * @since 2.0.0
 */
var init = function (as) { return (isNonEmpty(as) ? index$2.some(init$1(as)) : index$2.none); };
/**
...
var insertAt$1 = function (i, a) {
    return function (as) {
        return i < 0 || i > as.length ? index$2.none : index$2.some(unsafeInsertAt(i, a, as));
    };
};
/**
...
var deleteAt$1 = function (i) {
    return function (as) {
        return isOutOfBound(i, as) ? index$2.none : index$2.some(unsafeDeleteAt(i, as));
    };
};
/**
...
var modifyAt = function (i, f) {
    return function (as) {
        return isOutOfBound(i, as) ? index$2.none : index$2.some(unsafeUpdateAt$1(i, f(as[i]), as));
    };
};
/**
...
function comprehension(input, f, g) {
    ...
    var go = function (scope, input) {
        return isNonEmpty(input)
            ? flatMap(head$2(input), function (a) { return go(index$2.pipe(scope, append(a)), tail$1(input)); })
...
var _map$2 = function (fa, f) { return index$2.pipe(fa, map$2(f)); };
/* istanbul ignore next */
var _mapWithIndex$1 = function (fa, f) { return index$2.pipe(fa, mapWithIndex$1(f)); };
var _ap = function (fab, fa) { return index$2.pipe(fab, ap(fa)); };
/* istanbul ignore next */
var _filter$1 = function (fa, predicate) { return index$2.pipe(fa, filter$3(predicate)); };
/* istanbul ignore next */
var _filterMap$1 = function (fa, f) { return index$2.pipe(fa, filterMap$1(f)); };
/* istanbul ignore next */
var _partition$1 = function (fa, predicate) {
    return index$2.pipe(fa, partition$1(predicate));
};
/* istanbul ignore next */
var _partitionMap$1 = function (fa, f) { return index$2.pipe(fa, partitionMap$1(f)); };
/* istanbul ignore next */
var _partitionWithIndex$1 = function (fa, predicateWithIndex) { return index$2.pipe(fa, partitionWithIndex$1(predicateWithIndex)); };
/* istanbul ignore next */
var _partitionMapWithIndex$1 = function (fa, f) { return index$2.pipe(fa, partitionMapWithIndex$1(f)); };
/* istanbul ignore next */
var _alt = function (fa, that) { return index$2.pipe(fa, alt(that)); };
var _reduce$1 = function (fa, b, f) { return index$2.pipe(fa, reduce$1(b, f)); };
/* istanbul ignore next */
...
/* istanbul ignore next */
var _reduceRight$1 = function (fa, b, f) { return index$2.pipe(fa, reduceRight$1(b, f)); };
/* istanbul ignore next */
var _reduceWithIndex$1 = function (fa, b, f) {
    return index$2.pipe(fa, reduceWithIndex$1(b, f));
};
/* istanbul ignore next */
...
var _reduceRightWithIndex$1 = function (fa, b, f) {
    return index$2.pipe(fa, reduceRightWithIndex$1(b, f));
};
/* istanbul ignore next */
var _filterMapWithIndex$1 = function (fa, f) { return index$2.pipe(fa, filterMapWithIndex$1(f)); };
/* istanbul ignore next */
var _filterWithIndex$1 = function (fa, predicateWithIndex) { return index$2.pipe(fa, filterWithIndex$1(predicateWithIndex)); };
/* istanbul ignore next */
var _extend = function (fa, f) { return index$2.pipe(fa, extend(f)); };
/* istanbul ignore next */
 ...
 */
var ap = function (fa) {
    return flatMap(function (f) { return index$2.pipe(fa, map$2(f)); });
};
/**
 ...
 * @since 2.14.0
 */
var flatMap = /*#__PURE__*/ index$2.dual(2, function (ma, f) {
    return index$2.pipe(ma, chainWithIndex(function (i, a) { return f(a, i); }));
});
/**
 ...
 * @since 2.5.0
 */
var flatten = /*#__PURE__*/ flatMap(index$2.identity);
/**
 ...
 * @since 2.0.0
 */
var compact$1 = /*#__PURE__*/ filterMap$1(index$2.identity);
/**
...
var separate$1 = function (fa) {
    ...
    return index$2.separated(left, right);
};
/**
 ...
 * @since 2.0.0
 */
var duplicate = /*#__PURE__*/ extend(index$2.identity);
/**
...
var sequence$1 = function (F) {
    return function (ta) {
        return _reduce$1(ta, F.of(zero()), function (fas, fa) {
            return F.ap(F.map(fas, function (as) { return function (a) { return index$2.pipe(as, append(a)); }; }), fa);
        });
    };
};
/**
...
var traverseWithIndex$1 = function (F) {
    return function (f) {
        return reduceWithIndex$1(F.of(zero()), function (i, fbs, a) {
            return F.ap(F.map(fbs, function (bs) { return function (b) { return index$2.pipe(bs, append(b)); }; }), f(i, a));
        });
    };
};
/**
 ...
 * @since 2.10.0
 */
var flap = /*#__PURE__*/ index$2.flap(Functor);
/**
 * @category instances
 * @since 2.10.0
 */
 ...
 * @since 2.5.0
 */
var apFirst = /*#__PURE__*/ index$2.apFirst(Apply);
/**
 * Combine two effectful actions, keeping only the result of the second.
 *
 * @since 2.5.0
 */
var apSecond = /*#__PURE__*/ index$2.apSecond(Apply);
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 */
var chainFirst = 
/*#__PURE__*/ index$2.chainFirst(Chain);
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 * @since 2.11.0
 */
var guard = /*#__PURE__*/ index$2.guard(Zero, Pointed);
/**
 * @category instances
 * @since 2.7.0
 */
...
var _wither = /*#__PURE__*/ index$2.witherDefault(Traversable, Compactable);
var _wilt = /*#__PURE__*/ index$2.wiltDefault(Traversable, Compactable);
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 * @since 2.11.0
 */
var filterE = /*#__PURE__*/ index$2.filterE(Witherable);
/**
 * @category instances
 * @since 2.11.0
 */
 ...
 * @since 2.11.0
 */
var fromEitherK = /*#__PURE__*/ index$2.fromEitherK(FromEither);
// -------------------------------------------------------------------------------------
// unsafe
// -------------------------------------------------------------------------------------
/**
 ...
 * @since 2.9.0
 */
var Do = /*#__PURE__*/ of(index$2.emptyRecord);
/**
 * @category do notation
 * @since 2.8.0
 */
var bindTo = /*#__PURE__*/ index$2.bindTo(Functor);
var let_ = /*#__PURE__*/ index$2.let_(Functor);
/**
 * @category do notation
 * @since 2.8.0
 */
var bind = /*#__PURE__*/ index$2.bind(Chain);
/**
 * @category do notation
 * @since 2.8.0
 */
var apS = /*#__PURE__*/ index$2.apS(Apply);
// -------------------------------------------------------------------------------------
// legacy
// -------------------------------------------------------------------------------------
/**
...
/* istanbul ignore next */
var _map$1 = function (fa, f) { return index$2.pipe(fa, map$1()); };
/**
 * `map` can be used to turn functions `(a: A) => B` into functions `(fa: F<A>) => F<B>` whose argument and return types
 * use the type constructor `F` to represent some computational context.
 *
 ...
 * @since 2.0.0
 */
var map$1 = function () { return index$2.unsafeCoerce; };
/**
 * @category type lambdas
 * @since 2.0.0
 */
 ...
 */
var monoidAll = {
    concat: index$2.semigroupAll.concat,
    empty: true
};
/**
 ...
 */
var monoidAny = {
    concat: index$2.semigroupAny.concat,
    empty: false
};
 ...
 * @since 2.10.0
 */
var has = function (k, r) { return index$2.has.call(r, k); };
function deleteAt(k) {
    return function (r) {
        if (!index$2.has.call(r, k)) {
            return r;
...
function isSubrecord(E) {
    return function (me, that) {
        ...
        for (var k in me) {
            if (!index$2.has.call(that, k) || !E.equals(me[k], that[k])) {
                return false;
            }
        }
        return true;
...
function lookup(k, r) {
    ...
    return index$2.has.call(r, k) ? index$2.some(r[k]) : index$2.none;
}
/**
 * @since 2.5.0
 */
...
function fromFoldable(M, F) {
    ...
    return function (fka) { return fromFoldableMapM(fka, index$2.identity); };
}
function fromFoldableMap(M, F) {
    return function (ta, f) {
        return F.reduce(ta, {}, function (r, a) {
            var _a = f(a), k = _a[0], b = _a[1];
            r[k] = index$2.has.call(r, k) ? M.concat(r[k], b) : b;
            return r;
        });
    };
}
...
/** @internal */
var _map = function (fa, f) { return index$2.pipe(fa, map(f)); };
/** @internal */
/* istanbul ignore next */
var _mapWithIndex = function (fa, f) { return index$2.pipe(fa, mapWithIndex(f)); };
/** @internal */
/* istanbul ignore next */
var _reduce = function (O) {
    var reduceO = reduce(O);
    return function (fa, b, f) { return index$2.pipe(fa, reduceO(b, f)); };
};
/** @internal */
...
var _reduceRight = function (O) {
    ...
    return function (fa, b, f) { return index$2.pipe(fa, reduceRightO(b, f)); };
};
/** @internal */
/* istanbul ignore next */
var _filter = function (fa, predicate) {
    return index$2.pipe(fa, filter$2(predicate));
};
/** @internal */
/* istanbul ignore next */
var _filterMap = function (fa, f) { return index$2.pipe(fa, filterMap(f)); };
/** @internal */
/* istanbul ignore next */
var _partition = function (fa, predicate) { return index$2.pipe(fa, partition(predicate)); };
/** @internal */
/* istanbul ignore next */
var _partitionMap = function (fa, f) { return index$2.pipe(fa, partitionMap(f)); };
/** @internal */
/* istanbul ignore next */
var _reduceWithIndex = function (O) {
    var reduceWithIndexO = reduceWithIndex(O);
    return function (fa, b, f) { return index$2.pipe(fa, reduceWithIndexO(b, f)); };
};
/** @internal */
...
var _reduceRightWithIndex = function (O) {
    ...
    return function (fa, b, f) { return index$2.pipe(fa, reduceRightWithIndexO(b, f)); };
};
/** @internal */
/* istanbul ignore next */
var _partitionMapWithIndex = function (fa, f) { return index$2.pipe(fa, partitionMapWithIndex(f)); };
/** @internal */
/* istanbul ignore next */
var _partitionWithIndex = function (fa, predicateWithIndex) {
    return index$2.pipe(fa, partitionWithIndex(predicateWithIndex));
};
/** @internal */
/* istanbul ignore next */
var _filterMapWithIndex = function (fa, f) { return index$2.pipe(fa, filterMapWithIndex(f)); };
/** @internal */
/* istanbul ignore next */
var _filterWithIndex = function (fa, predicateWithIndex) { return index$2.pipe(fa, filterWithIndex(predicateWithIndex)); };
/** @internal */
var _traverse = function (O) {
    var traverseWithIndexO = _traverseWithIndex(O);
    return function (F) {
        var traverseWithIndexOF = traverseWithIndexO(F);
        return function (ta, f) { return traverseWithIndexOF(ta, index$2.flow(index$2.SK, f)); };
    };
};
/** @internal */
var _sequence = function (O) {
    ...
    return function (F) {
        ...
        return function (ta) { return traverseOF(ta, index$2.identity); };
    };
};
...
function getMonoid(S) {
    return {
        concat: function (first, second) {
            ...
            for (var k in second) {
                if (index$2.has.call(second, k)) {
                    r[k] = index$2.has.call(first, k) ? S.concat(first[k], second[k]) : second[k];
                }
            }
            return r;
        },
...
function hasOwnProperty(k, r) {
    return index$2.has.call(r === undefined ? this : r, k);
}
...
/** @internal */
var isoAsLens = function (sa) { return lens$2(sa.get, index$2.flow(sa.reverseGet, index$2.constant)); };
/** @internal */
var isoAsPrism = function (sa) { return prism(index$2.flow(sa.get, index$2.some$1), sa.reverseGet); };
/** @internal */
var isoAsOptional = function (sa) {
    return optional(index$2.flow(sa.get, index$2.some$1), index$2.flow(sa.reverseGet, index$2.constant));
};
/** @internal */
...
/** @internal */
var lensAsOptional = function (sa) { return optional(index$2.flow(sa.get, index$2.some$1), sa.set); };
/** @internal */
...
var prismComposePrism = function (ab) { return function (sa) {
    return prism(index$2.flow(sa.getOption, index$2.chain(ab.getOption)), index$2.flow(ab.reverseGet, sa.reverseGet));
}; };
/** @internal */
...
/** @internal */
var lensId = function () { return lens$2(index$2.identity, index$2.constant); };
/** @internal */
...
var lensAtKey = function (key) { return function (sa) {
    return index$2.pipe$1(sa, lensComposeLens(atReadonlyRecord().at(key)));
}; };
// -------------------------------------------------------------------------------------
// Prism
// -------------------------------------------------------------------------------------
...
var prismAsTraversal = function (sa) {
    return traversal(function (F) { return function (f) { return function (s) {
        return index$2.pipe$1(sa.getOption(s), index$2.fold(function () { return F.of(s); }, function (a) { return F.map(f(a), function (a) { return prismSet(a)(sa)(s); }); }));
    }; }; });
};
/** @internal */
var prismModifyOption = function (f) { return function (sa) { return function (s) {
    return index$2.pipe$1(sa.getOption(s), index$2.map(function (o) {
        var n = f(o);
...
var prismModify = function (f) { return function (sa) {
    ...
    return function (s) {
        return index$2.pipe$1(g(s), index$2.getOrElse(function () { return s; }));
    };
}; };
/** @internal */
...
/** @internal */
var prismFromNullable = function () { return prism(index$2.fromNullable, index$2.identity); };
/** @internal */
var prismFromPredicate = function (predicate) {
    return prism(index$2.fromPredicate(predicate), index$2.identity);
};
/** @internal */
var prismSome = function () { return prism(index$2.identity, index$2.some$1); };
/** @internal */
var prismRight = function () { return prism(index$2.fromEither, index$2.right); };
/** @internal */
var prismLeft = function () {
    return prism(function (s) { return (index$2.isLeft$1(s) ? index$2.some$1(s.left) : index$2.none$1); }, // TODO: replace with E.getLeft in v3
    index$2.left);
};
// -------------------------------------------------------------------------------------
// Optional
...
var optionalAsTraversal = function (sa) {
    return traversal(function (F) { return function (f) { return function (s) {
        return index$2.pipe$1(sa.getOption(s), index$2.fold(function () { return F.of(s); }, function (a) { return F.map(f(a), function (a) { return sa.set(a)(s); }); }));
    }; }; });
};
/** @internal */
var optionalModifyOption = function (f) { return function (optional) { return function (s) {
    return index$2.pipe$1(optional.getOption(s), index$2.map(function (a) {
        var n = f(a);
...
var optionalComposeOptional = function (ab) { return function (sa) {
    return optional(index$2.flow(sa.getOption, index$2.chain(ab.getOption)), function (b) { return optionalModify(ab.set(b))(sa); });
}; };
/** @internal */
var optionalIndex = function (i) { return function (sa) {
    return index$2.pipe$1(sa, optionalComposeOptional(indexReadonlyArray().index(i)));
}; };
/** @internal */
var optionalIndexNonEmpty = function (i) { return function (sa) { return index$2.pipe$1(sa, optionalComposeOptional(indexReadonlyNonEmptyArray().index(i))); }; };
/** @internal */
var optionalKey = function (key) { return function (sa) {
    return index$2.pipe$1(sa, optionalComposeOptional(indexReadonlyRecord().index(key)));
}; };
/** @internal */
var optionalFindFirst = function (predicate) {
    return optional(findFirst$2(predicate), function (a) { return function (s) {
        return index$2.pipe$1(findIndex$1(predicate)(s), index$2.fold(function () { return s; }, function (i) { return unsafeUpdateAt$2(i, a, s); }));
    }; });
};
...
var optionalFindFirstNonEmpty = function (predicate) {
    return optional(findFirst$2(predicate), function (a) { return function (as) {
        return index$2.pipe$1(findIndex$1(predicate)(as), index$2.fold(function () { return as; }, function (i) { return unsafeUpdateAt(i, a, as); }));
    }; });
};
// -------------------------------------------------------------------------------------
// Traversal
...
var indexReadonlyArray = function () {
    return index$1(function (i) {
        return optional(function (as) { return lookup$2(i, as); }, function (a) { return function (as) {
            return index$2.pipe$1(lookup$2(i, as), index$2.fold(function () { return as; }, function () { return unsafeUpdateAt$2(i, a, as); }));
        }; });
    });
};
/** @internal */
var indexReadonlyNonEmptyArray = function () {
    return index$1(function (i) {
        return optional(function (as) { return lookup$2(i, as); }, function (a) { return function (as) {
            return index$2.pipe$1(lookup$2(i, as), index$2.fold(function () { return as; }, function () { return unsafeUpdateAt(i, a, as); }));
        }; });
    });
};
/** @internal */
var indexReadonlyRecord = function () {
    return index$1(function (k) {
        return optional(function (r) { return lookup(k, r); }, function (a) { return function (r) {
            if (r[k] === a || index$2.isNone$1(lookup(k, r))) {
                return r;
            }
...
function atReadonlyRecord() {
    return at(function (key) {
        return lens$2(function (r) { return lookup(key, r); }, index$2.fold(function () { return deleteAt(key); }, function (a) { return insertAt(key, a); }));
    });
}
...
var compose$4 = function (ab) { return function (sa) {
    return iso$1(index$2.flow(sa.get, ab.get), index$2.flow(ab.reverseGet, sa.reverseGet));
}; };
// -------------------------------------------------------------------------------------
// combinators
// -------------------------------------------------------------------------------------
...
var composeIso = 
/*#__PURE__*/
index$2.flow(isoAsLens, compose$3);
/**
...
var composeOptional = function (ab) {
    return index$2.flow(asOptional$1, optionalComposeOptional(ab));
};
/**
...
var composeTraversal = function (ab) {
    return index$2.flow(asTraversal$2, traversalComposeTraversal(ab));
};
// -------------------------------------------------------------------------------------
// combinators
// -------------------------------------------------------------------------------------
...
function modifyF(F) {
    return function (f) { return function (sa) { return function (s) { return index$2.pipe$1(sa.get(s), f, function (fa) { return F.map(fa, function (a) { return sa.set(a)(s); }); }); }; }; };
}
/**
...
var index = function (i) {
    return index$2.flow(asOptional$1, optionalIndex(i));
};
/**
...
var indexNonEmpty = function (i) {
    return index$2.flow(asOptional$1, optionalIndexNonEmpty(i));
};
/**
...
var key = function (key) {
    return index$2.flow(asOptional$1, optionalKey(key));
};
/**
 ...
 */
function traverse(T) {
    return index$2.flow(asTraversal$2, traversalTraverse(T));
}
...
// instances
// -------------------------------------------------------------------------------------
var imap_ = function (ea, ab, ba) { return lens(index$2.flow(ea.get, ab), index$2.flow(ba, ea.set)); };
/**
 * @category instances
 * @since 2.3.0
 */
...
var Iso = /** @class */ (function () {
    ...
    Iso.prototype.composeLens = function (ab) {
        return fromLens(index$2.pipe$1(this, asLens, compose$3(ab)));
    };
    /**
    ...
    Iso.prototype.composePrism = function (ab) {
        return fromPrism(index$2.pipe$1(this, asPrism, compose$1(ab)));
    };
    /**
    ...
    Iso.prototype.composeOptional = function (ab) {
        return fromOptional(index$2.pipe$1(this, asOptional$2, compose$2(ab)));
    };
    /**
    ...
    Iso.prototype.composeTraversal = function (ab) {
        return fromTraversal(index$2.pipe$1(this, asTraversal$3, compose(ab)));
    };
    /**
...
var Lens = /** @class */ (function () {
    ...
    Lens.fromProp = function () {
        return function (prop$1) { return fromLens(index$2.pipe$1(id(), prop(prop$1))); };
    };
    Lens.fromProps = function () {
        return function (props$1) { return fromLens(index$2.pipe$1(id(), props.apply(lens$1, props$1))); };
    };
    /**
    ...
    Lens.fromNullableProp = function () {
        return function (k, defaultValue) {
            return new Lens(function (s) {
                var osk = index$2.fromNullable(s[k]);
                if (index$2.isNone$1(osk)) {
                    return defaultValue;
                }
                else {
                    return osk.value;
    ...
    Lens.prototype.composeOptional = function (ab) {
        return fromOptional(index$2.pipe$1(this, asOptional$1, compose$2(ab)));
    };
    /**
     * compose a `Lens` with an `Traversal`
     *
    ...
    Lens.prototype.composeTraversal = function (ab) {
        return fromTraversal(index$2.pipe$1(this, asTraversal$2, compose(ab)));
    };
    /**
    ...
    Lens.prototype.composeIso = function (ab) {
        return fromLens(index$2.pipe$1(this, compose$3(index$2.pipe$1(ab, asLens))));
    };
    /**
     * compose a `Lens` with a `Prism`
     *
...
var Prism = /** @class */ (function () {
    ...
    Prism.prototype.modifyOption = function (f) {
        var _this = this;
        return function (s) {
            return index$2.option.map(_this.getOption(s), function (v) {
                var n = f(v);
    ...
    Prism.prototype.asFold = function () {
        ...
        return new Fold(function (M) { return function (f) { return function (s) {
            ...
            return index$2.isNone$1(oa) ? M.empty : f(oa.value);
        }; }; });
    };
    /**
     * compose a `Prism` with a `Prism`
    ...
    Prism.prototype.composeOptional = function (ab) {
        return fromOptional(index$2.pipe$1(this, asOptional, compose$2(ab)));
    };
    /**
    ...
    Prism.prototype.composeTraversal = function (ab) {
        return fromTraversal(index$2.pipe$1(this, asTraversal, compose(ab)));
    };
    /**
    ...
    Prism.prototype.composeIso = function (ab) {
        return fromPrism(index$2.pipe$1(this, compose$1(index$2.pipe$1(ab, asPrism))));
    };
    /**
     * compose a `Prism` with a `Lens`
     *
...
var somePrism = 
/*#__PURE__*/
new Prism(index$2.identity, index$2.some$1);
/**
 * Laws:
...
var Optional = /** @class */ (function () {
    ...
    Optional.fromNullableProp = function () {
        return function (k) {
            return new Optional(function (s) { return index$2.fromNullable(s[k]); }, function (a) { return function (s) { return (s[k] == null ? s : update(s, k, a)); }; });
        };
    };
    /**
    ...
    Optional.prototype.composeTraversal = function (ab) {
        return fromTraversal(index$2.pipe$1(this, asTraversal$1, compose(ab)));
    };
    /**
    ...
    Optional.prototype.composeLens = function (ab) {
        return fromOptional(index$2.pipe$1(this, compose$2(index$2.pipe$1(ab, asOptional$1))));
    };
    /**
    ...
    Optional.prototype.composePrism = function (ab) {
        return fromOptional(index$2.pipe$1(this, compose$2(index$2.pipe$1(ab, asOptional))));
    };
    /**
    ...
    Optional.prototype.composeIso = function (ab) {
        return fromOptional(index$2.pipe$1(this, compose$2(index$2.pipe$1(ab, asOptional$2))));
    };
    /**
...
var Traversal = /** @class */ (function () {
    ...
    Traversal.prototype.composeLens = function (ab) {
        return fromTraversal(index$2.pipe$1(this, compose(index$2.pipe$1(ab, asTraversal$2))));
    };
    /**
    ...
    Traversal.prototype.composePrism = function (ab) {
        return fromTraversal(index$2.pipe$1(this, compose(index$2.pipe$1(ab, asTraversal))));
    };
    /**
    ...
    Traversal.prototype.composeIso = function (ab) {
        return fromTraversal(index$2.pipe$1(this, compose(index$2.pipe$1(ab, asTraversal$3))));
    };
    /**
...
var Fold = /** @class */ (function () {
    function Fold(foldMap) {
        ...
        this.foldMapFirst = foldMap(index$2.getFirstMonoid());
    }
    /**
    ...
    Fold.prototype.find = function (p) {
        return this.foldMapFirst(index$2.fromPredicate(p));
    };
    /**
...
var Setter = /** @class */ (function () {
    ...
    Setter.prototype.set = function (a) {
        return this.modify(index$2.constant(a));
    };
    /**
...
var anyIso = 
/*#__PURE__*/
new Iso(index$2.unsafeCoerce, index$2.unsafeCoerce);
/**
 * @since 0.2.0
 */
function iso() {
...
function fromNewtype(codec, name) {
    ...
    var i = iso();
    return new index$2.Type(name, function (u) { return codec.is(u); }, function (u, c) {
        return index$2.pipe$1(codec.validate(u, c), index$2.map$1(i.wrap));
    }, function (a) { return codec.encode(i.unwrap(a)); });
}

const TransactionId = fromNewtype(index$2.lib.string);
const unTransactionId = iso().unwrap;
const transactionId = iso().wrap;
const idToTxId = (transactionId) => index$2._function.pipe(transactionId, unTransactionId);
...
exports.unTransactionId = unTransactionId;
exports.union = union;
