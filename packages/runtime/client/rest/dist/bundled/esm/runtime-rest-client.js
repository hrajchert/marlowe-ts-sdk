import { c as commonjsGlobal, S as Separated, _ as _function, F as Functor$1, E as Either, A as Apply, C as Chain, i as internal, a as Applicative, b as FromEither, W as Witherable$1, g as getAugmentedNamespace, d as Either$1, O as Option$1, s as some$1, n as none, h as has$6, e as isNone, p as pipe, f as flap$1, w as witherDefault, j as wiltDefault, l as last, k as pipeable, m as lib$1 } from './index-bba2aa9d.js';
import { MarloweJSONCodec } from '@marlowe.io/adapter/codec';
import * as HTTP from '@marlowe.io/adapter/http';
import { O as Option, P as Predicate, S as Semigroup, E as Eq, a as Ord, Z as Zero, r as require$$3$1, b as PayoutHeader, o as optionFromNullable, c as PayoutStatus, W as WithdrawalDetails, d as WithdrawalHeader, T as TxStatus } from './index-a92096c8.js';
export { A as Available, e as Withdrawn } from './index-a92096c8.js';
import { _ as _Array$1, N as NonEmptyArray$1, s as size$1, i as isEmpty$1, O as Ord$1, u as upsertAt$1, h as has$5, a as isSubrecord$1, l as lookup$1, m as mapWithIndex$1, b as map$2, r as reduceWithIndex$1, f as foldMapWithIndex$1, c as reduceRightWithIndex$1, d as singleton$1, t as traverseWithIndex$1, e as traverse$1, g as sequence$1, p as partitionMapWithIndex$1, j as partitionWithIndex$1, k as filterMapWithIndex$1, n as filterWithIndex$1, o as fromFoldable$1, q as fromFoldableMap$1, v as every$1, w as some$2, x as elem$1, y as intersection$1, z as difference$1, A as filter$2, B as filterMap$2, C as partition$2, D as partitionMap$2, E as reduce$1, F as foldMap$1, G as reduceRight$1, H as compact$3, I as separate$2, J as getShow$1, K as getEq$1, L as getMonoid$1, M as hasOwnProperty$2, P as union$1, Q as _map$1, R as _mapWithIndex$1, S as _reduce$1, T as _foldMap$1, U as _reduceRight$1, V as _filter$1, W as _filterMap$1, X as _partition$1, Y as _partitionMap$1, Z as _reduceWithIndex$1, $ as _foldMapWithIndex$1, a0 as _reduceRightWithIndex$1, a1 as _partitionMapWithIndex$1, a2 as _partitionWithIndex$1, a3 as _filterMapWithIndex$1, a4 as _filterWithIndex$1, a5 as _traverse$1, a6 as _sequence$1, a7 as Foldable$1, a8 as fromNewtype, a9 as iso, aa as TransactionId, ab as unTransactionId } from './index-a9fad1a0.js';
import { unPolicyId, unContractId, AssetQuantity, PayoutId, ContractId, AssetId, AddressBech32, WithdrawalId, unPayoutId, transactionWitnessSetTextEnvelope, unWithdrawalId, TextEnvelope, unAddressBech32, unTxOutRef, TxOutRef, PolicyId as PolicyId$1, Metadata, BlockHeader, Tags, TxId } from '@marlowe.io/runtime-core';
import { PolicyId, Contract, Input, BuiltinByteString } from '@marlowe.io/language-core-v1';
...
var require$$0$1 = /*@__PURE__*/getAugmentedNamespace(_Array$1);

var require$$1 = /*@__PURE__*/getAugmentedNamespace(Either$1);

var require$$2 = /*@__PURE__*/getAugmentedNamespace(NonEmptyArray$1);

var require$$3 = /*@__PURE__*/getAugmentedNamespace(Option$1);
 ...
 * @since 2.0.0
 */
var toArray = /*#__PURE__*/ collect(Ord$1)(function (k, a) { return [
    k,
    a
]; });
function toUnfoldable(U) {
    return function (r) {
        var sas = toArray(r);
        var len = sas.length;
        return U.unfold(0, function (b) { return (b < len ? some$1([sas[b], b + 1]) : none); });
    };
}
/**
...
function pop(k) {
    ...
    return function (r) {
        var oa = lookup(k, r);
        return isNone(oa) ? none : some$1([oa.value, deleteAtk(r)]);
    };
}
// TODO: remove non-curried overloading in v3
/**
...
var wither = function (F) {
    ...
    return function (f) { return function (fa) { return F.map(pipe(fa, traverseF(f)), compact$1); }; };
};
/**
 * @category filtering
 * @since 2.6.5
 ...
 * @category conversions
 */
var fromEntries = function (fa) { return fromFoldable(last(), Foldable$1)(fa); };
...
var intersection = function (M) {
    return function (second) {
        return function (first) {
            ...
            return intersection$1(M)(second)(first);
        };
    };
};
/**
...
var difference = function (second) {
    return function (first) {
        ...
        return difference$1(second)(first);
    };
};
var _map = _map$1;
 ...
 * @since 2.0.0
 */
var partitionMap = partitionMap$2;
function reduce() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    }
    return args.length === 1 ? reduce$1(args[0]) : reduce$1(Ord$1).apply(void 0, args);
}
function foldMap(O) {
    return 'compare' in O ? foldMap$1(O) : foldMap$1(Ord$1)(O);
}
function reduceRight() {
    ...
    return args.length === 1 ? reduceRight$1(args[0]) : reduceRight$1(Ord$1).apply(void 0, args);
}
/**
...
var URI = 'Record';
function getShow(O) {
    return 'compare' in O ? getShow$1(O) : getShow$1(Ord$1)(O);
}
/**
 ...
 * @since 2.10.0
 */
var flap = /*#__PURE__*/ flap$1(Functor);
/**
 * @category instances
 * @since 2.7.0
 */
...
var Foldable = {
    URI: URI,
    reduce: /*#__PURE__*/ _reduce(Ord$1),
    foldMap: /*#__PURE__*/ _foldMap(Ord$1),
    reduceRight: /*#__PURE__*/ _reduceRight(Ord$1)
};
/**
...
var FoldableWithIndex = {
    ...
    foldMap: /*#__PURE__*/ _foldMap(Ord$1),
    reduceRight: /*#__PURE__*/ _reduceRight(Ord$1),
    reduceWithIndex: /*#__PURE__*/ _reduceWithIndex(Ord$1),
    foldMapWithIndex: /*#__PURE__*/ _foldMapWithIndex(Ord$1),
    reduceRightWithIndex: /*#__PURE__*/ _reduceRightWithIndex(Ord$1)
};
/**
...
var Traversable = {
    ...
    foldMap: /*#__PURE__*/ _foldMap(Ord$1),
    reduceRight: /*#__PURE__*/ _reduceRight(Ord$1),
    traverse: /*#__PURE__*/ _traverse(Ord$1),
    sequence: sequence
};
/**
...
var TraversableWithIndex = {
    ...
    traverse: /*#__PURE__*/ _traverse(Ord$1),
    sequence: sequence,
    traverseWithIndex: /*#__PURE__*/ _traverseWithIndex(Ord$1)
};
...
var require$$5 = /*@__PURE__*/getAugmentedNamespace(pipeable);
...
(function (exports) {
	...
	var t = __importStar(require$$3$1);
...
const ContractsRange$1 = fromNewtype(lib$1.string);
const unContractsRange$1 = iso().unwrap;
iso().wrap;
...
const statusOptionToParameter = (statusOption) => _function.pipe(statusOption, Option.match(() => "", (a) => `status=${a}&`));
const getHeadersByRangeViaAxios$3 = (axiosInstance) => (rangeOption) => (contractIds) => (roles) => (statusOption) => _function.pipe({
    url: "/payouts?" +
    ...
    configs: _function.pipe(rangeOption, Option.match(() => ({}), (range) => ({ headers: { Range: unContractsRange$1(range) } }))),
}, ({ url, configs }) => HTTP.GetWithDataAndHeaders(axiosInstance)(url, configs), TaskEither.map(([headers, data]) => ({
    data: data,
    previousRange: headers["prev-range"],
    nextRange: headers["next-range"],
})), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(GETByRangeRawResponse$3.decode(data)))), TaskEither.map((rawResponse) => ({
    headers: _function.pipe(rawResponse.data.results, _Array.map((result) => result.resource)),
    previousRange: rawResponse.previousRange,
    nextRange: rawResponse.nextRange,
})));
const GETByRangeRawResponse$3 = lib$1.type({
    data: lib$1.type({
        results: lib$1.array(lib$1.type({ links: lib$1.type({ payout: lib$1.string }), resource: PayoutHeader })),
    }),
    previousRange: optionFromNullable(ContractsRange$1),
    nextRange: optionFromNullable(ContractsRange$1),
});
lib$1.type({
    headers: lib$1.array(PayoutHeader),
    previousRange: optionFromNullable(ContractsRange$1),
    nextRange: optionFromNullable(ContractsRange$1),
});

const Tokens = lib$1.record(lib$1.string, lib$1.record(lib$1.string, lib$1.bigint));
const Assets = lib$1.type({ lovelace: AssetQuantity, tokens: Tokens });
const PayoutDetails = lib$1.type({
    payoutId: PayoutId,
...
const GETPayload$2 = lib$1.type({ links: lib$1.type({}), resource: PayoutDetails });
const getViaAxios$4 = (axiosInstance) => (contractId) => _function.pipe(HTTP.Get(axiosInstance)(contractEndpoint$1(contractId), {
    headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    },
}), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(GETPayload$2.decode(data)))), TaskEither.map((payload) => payload.resource));
const contractEndpoint$1 = (payoutId) => `/payouts/${encodeURIComponent(unPayoutId(payoutId))}`;

const getViaAxios$3 = (axiosInstance) => (withdrawalId) => _function.pipe(HTTP.Get(axiosInstance)(endpointURI$1(withdrawalId), {
    headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    },
}), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(WithdrawalDetails.decode(data)))));
const putViaAxios$2 = (axiosInstance) => (withdrawalId, hexTransactionWitnessSet) => _function.pipe(HTTP.Put(axiosInstance)(endpointURI$1(withdrawalId), transactionWitnessSetTextEnvelope(hexTransactionWitnessSet), {
    headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    },
}));
const endpointURI$1 = (withdrawalId) => `/withdrawals/${encodeURIComponent(unWithdrawalId(withdrawalId))}`;

const WithdrawalsRange = fromNewtype(lib$1.string);
const unWithdrawalsRange = iso().unwrap;
iso().wrap;
const getHeadersByRangeViaAxios$2 = (axiosInstance) => (rangeOption) => _function.pipe(HTTP.GetWithDataAndHeaders(axiosInstance)("/withdrawals", _function.pipe(rangeOption, Option.match(() => ({}), (range) => ({ headers: { Range: unWithdrawalsRange(range) } })))), TaskEither.map(([headers, data]) => ({
    data: data,
    previousRange: headers["prev-range"],
    nextRange: headers["next-range"],
})), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(GETByRangeRawResponse$2.decode(data)))), TaskEither.map((rawResponse) => ({
    headers: _function.pipe(rawResponse.data.results, _Array.map((result) => result.resource)),
    previousRange: rawResponse.previousRange,
    nextRange: rawResponse.nextRange,
})));
const GETByRangeRawResponse$2 = lib$1.type({
    data: lib$1.type({
        results: lib$1.array(lib$1.type({
            links: lib$1.type({ contract: lib$1.string, transactions: lib$1.string }),
...
lib$1.type({
    headers: lib$1.array(WithdrawalHeader),
    previousRange: optionFromNullable(WithdrawalsRange),
    nextRange: optionFromNullable(WithdrawalsRange),
});
const WithdrawalTextEnvelope = lib$1.type({
    withdrawalId: WithdrawalId,
    tx: TextEnvelope,
});
const PostResponse$2 = lib$1.type({
    links: lib$1.type({}),
    resource: WithdrawalTextEnvelope,
});
const postViaAxios$2 = (axiosInstance) => (payoutIds, addressesAndCollaterals) => _function.pipe(HTTP.Post(axiosInstance)("/withdrawals", { payouts: payoutIds }, {
    headers: {
        ...
        "X-Address": _function.pipe(addressesAndCollaterals.usedAddresses, _Array.map(unAddressBech32), (a) => a.join(",")),
        "X-Collateral-UTxO": _function.pipe(addressesAndCollaterals.collateralUTxOs, _Array.map(unTxOutRef), (a) => a.join(",")),
    },
}), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(PostResponse$2.decode(data)))), TaskEither.map((payload) => payload.resource));

const RoleName = lib$1.string;
const UsePolicy = PolicyId;
const RoleTokenSimple = AddressBech32;
const TokenMetadataFile = lib$1.type({
    name: lib$1.string,
    src: lib$1.string,
    mediaType: lib$1.string,
});
const TokenMetadata = lib$1.type({
    name: optionFromNullable(lib$1.string),
    image: optionFromNullable(lib$1.string),
    mediaType: lib$1.string,
    description: lib$1.string,
    files: lib$1.array(TokenMetadataFile),
});
const RoleTokenAdvanced = lib$1.type({
    address: AddressBech32,
    metadata: TokenMetadata,
});
const RoleTokenConfig = lib$1.union([RoleTokenSimple, RoleTokenAdvanced]);
const Mint = lib$1.record(RoleName, RoleTokenConfig);
const RolesConfig = lib$1.union([UsePolicy, Mint]);

const Payout = lib$1.type({ payoutId: TxOutRef, role: RoleName });
const ContractDetails = lib$1.type({
    contractId: ContractId,
    roleTokenMintingPolicyId: PolicyId$1,
    ...
    unclaimedPayouts: lib$1.array(Payout),
});

const GETPayload$1 = lib$1.type({ links: lib$1.type({}), resource: ContractDetails });
const getViaAxios$2 = (axiosInstance) => (contractId) => _function.pipe(HTTP.Get(axiosInstance)(contractEndpoint(contractId), {
    headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    },
}), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(GETPayload$1.decode(data)))), TaskEither.map((payload) => payload.resource));
const putViaAxios$1 = (axiosInstance) => (contractId, hexTransactionWitnessSet) => _function.pipe(HTTP.Put(axiosInstance)(contractEndpoint(contractId), transactionWitnessSetTextEnvelope(hexTransactionWitnessSet), {
    headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    },
...
const ContractsRange = fromNewtype(lib$1.string);
const unContractsRange = iso().unwrap;
iso().wrap;
const getHeadersByRangeViaAxios$1 = (axiosInstance) => (rangeOption) => (tags) => _function.pipe({
    url: "/contracts?" + lib.stringify({ tag: tags }, { indices: false }),
    configs: _function.pipe(rangeOption, Option.match(() => ({}), (range) => ({ headers: { Range: unContractsRange(range) } }))),
}, ({ url, configs }) => HTTP.GetWithDataAndHeaders(axiosInstance)(url, configs), TaskEither.map(([headers, data]) => ({
    data: data,
    previousRange: headers["prev-range"],
    nextRange: headers["next-range"],
})), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(GETByRangeRawResponse$1.decode(data)))), TaskEither.map((rawResponse) => ({
    headers: _function.pipe(rawResponse.data.results, _Array.map((result) => result.resource), _Array.filter((header) => eqSetString(new Set(Object.keys(header.tags)), new Set(tags)))),
    previousRange: rawResponse.previousRange,
    nextRange: rawResponse.nextRange,
})));
const eqSetString = (xs, ys) => xs.size === ys.size && [...xs].every((x) => ys.has(x));
const GETByRangeRawResponse$1 = lib$1.type({
    data: lib$1.type({
        results: lib$1.array(lib$1.type({
            links: lib$1.type({ contract: lib$1.string, transactions: lib$1.string }),
            resource: Header$1,
...
lib$1.intersection([
    lib$1.type({
        ...
        tags: Tags,
        metadata: Metadata,
        minUTxODeposit: lib$1.number,
    }),
    lib$1.partial({ roles: RolesConfig }),
]);
const ContractTextEnvelope = lib$1.type({
    contractId: ContractId,
    tx: TextEnvelope,
});
const PostResponse$1 = lib$1.type({
    links: lib$1.type({ contract: lib$1.string }),
    resource: ContractTextEnvelope,
});
const postViaAxios$1 = (axiosInstance) => (postContractsRequest, addressesAndCollaterals) => _function.pipe(HTTP.Post(axiosInstance)("/contracts", postContractsRequest, {
    headers: {
...
}), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(PostResponse$1.decode(data)))), TaskEither.map((payload) => payload.resource));

const Details = lib$1.type({
    contractId: ContractId,
...
const GETPayload = lib$1.type({ links: lib$1.type({}), resource: Details });
const getViaAxios$1 = (axiosInstance) => (contractId, transactionId) => _function.pipe(HTTP.Get(axiosInstance)(endpointURI(contractId, transactionId), {
    headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    },
}), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(GETPayload.decode(data)))), TaskEither.map((payload) => payload.resource));
const putViaAxios = (axiosInstance) => (contractId, transactionId, hexTransactionWitnessSet) => _function.pipe(HTTP.Put(axiosInstance)(endpointURI(contractId, transactionId), transactionWitnessSetTextEnvelope(hexTransactionWitnessSet), {
    headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    },
}));
const endpointURI = (contractId, transactionId) => `/contracts/${_function.pipe(contractId, unContractId, encodeURIComponent)}/transactions/${_function.pipe(transactionId, unTransactionId, encodeURIComponent)}`;

const Header = lib$1.type({
    contractId: ContractId,
    transactionId: TransactionId,
    continuations: optionFromNullable(BuiltinByteString),
    tags: Tags,
...
const TransactionsRange = fromNewtype(lib$1.string);
const unTransactionsRange = iso().unwrap;
iso().wrap;
const getHeadersByRangeViaAxios = (axiosInstance) => (contractId, rangeOption) => _function.pipe(HTTP.GetWithDataAndHeaders(axiosInstance)(transactionsEndpoint(contractId), _function.pipe(rangeOption, Option.match(() => ({}), (range) => ({ headers: { Range: unTransactionsRange(range) } })))), TaskEither.map(([headers, data]) => ({
    data: data,
    previousRange: headers["prev-range"],
    nextRange: headers["next-range"],
})), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(GETByRangeRawResponse.decode(data)))), TaskEither.map((rawResponse) => ({
    headers: _function.pipe(rawResponse.data.results, _Array.map((result) => result.resource)),
    previousRange: rawResponse.previousRange,
    nextRange: rawResponse.nextRange,
})));
const GETByRangeRawResponse = lib$1.type({
    data: lib$1.type({
        results: lib$1.array(lib$1.type({ links: lib$1.type({}), resource: Header })),
    }),
    previousRange: optionFromNullable(TransactionsRange),
    nextRange: optionFromNullable(TransactionsRange),
});
lib$1.type({
    headers: lib$1.array(Header),
    previousRange: optionFromNullable(TransactionsRange),
    nextRange: optionFromNullable(TransactionsRange),
});
const TransactionTextEnvelope = lib$1.type({
    contractId: ContractId,
    transactionId: TransactionId,
    tx: TextEnvelope,
});
const postViaAxios = (axiosInstance) => (contractId, postTransactionsRequest, addressesAndCollaterals) => _function.pipe(HTTP.Post(axiosInstance)(transactionsEndpoint(contractId), postTransactionsRequest, {
    headers: {
...
}), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(PostResponse.decode(data)))), TaskEither.map((payload) => payload.resource));
lib$1.intersection([
    lib$1.type({
        version: MarloweVersion,
        inputs: lib$1.array(Input),
    ...
    lib$1.partial({ invalidBefore: ISO8601 }),
    lib$1.partial({ invalidHereafter: ISO8601 }),
]);
const PostResponse = lib$1.type({
    links: lib$1.type({ transaction: lib$1.string }),
...
const getViaAxios = (axiosInstance) => (contractId) => (environment) => (parties) => _function.pipe(HTTP.Get(axiosInstance)(contractNextEndpoint(contractId) +
...
}), TaskEither.chainW((data) => TaskEither.fromEither(Either.mapLeft(src$1.formatValidationErrors)(Next.decode(data)))));
const contractNextEndpoint = (contractId) => `/contracts/${encodeURIComponent(unContractId(contractId))}/next`;

const mkRestClient = (baseURL) => _function.pipe(axios$1.create({
    baseURL: baseURL,
...
export { Assets, ContractDetails, Header$1 as Header, Mint, Payout, PayoutDetails, PayoutHeader, PayoutStatus, RoleName, RoleTokenAdvanced, RoleTokenConfig, RoleTokenSimple, RolesConfig, TokenMetadata, TokenMetadataFile, Tokens, UsePolicy, WithdrawalDetails, WithdrawalHeader, mkRestClient };
