import { _ as _function, c as commonjsGlobal, i as internal, C as Chain, a as Applicative, A as Apply, b as FromEither, F as Functor, S as Separated, W as Witherable, g as getAugmentedNamespace, aj as es6, ak as strict, al as literal, am as union, ah as Type, an as success, a3 as pipe, ao as toNullable, a8 as map$1, ai as map$2, a1 as some, ae as none, m as lib, E as Either } from './index-bba2aa9d.js';
import { ContractId, PayoutId, AssetId, WithdrawalId, BlockHeader } from '@marlowe.io/runtime-core';
...
var require$$3 = /*@__PURE__*/getAugmentedNamespace(es6);

var None$1 = strict({
    _tag: literal('None')
}, 'None');
var someLiteral$1 = literal('Some');
/**
 * @since 0.5.0
 */
...
function optionFromNullable$2(codec, name) {
    if (name === void 0) { name = "Option<" + codec.name + ">"; }
    return new Type(name, option$2(codec).is, function (u, c) {
        return u == null
            ? success(none)
            : pipe(codec.validate(u, c), map$2(some));
    }, function (a) {
        return toNullable(pipe(a, map$1(codec.encode)));
    });
}

const Available = lib.literal("available");
const Withdrawn = lib.literal("withdrawn");
const PayoutStatus = lib.union([Available, Withdrawn]);

const PayoutHeader = lib.type({
    contractId: ContractId,
    payoutId: PayoutId,
    withdrawalId: optionFromNullable$2(WithdrawalId),
    role: AssetId,
    status: PayoutStatus,
});

const TxStatus = lib.union([
    lib.literal("unsigned"),
    lib.literal("submitted"),
    lib.literal("confirmed"),
]);
...
const WithdrawalDetails = lib.type({
    withdrawalId: WithdrawalId,
    status: TxStatus,
    block: optionFromNullable_2(BlockHeader),
    payouts: lib.array(PayoutHeader),
});

const WithdrawalHeader = lib.type({
    withdrawalId: WithdrawalId,
    status: TxStatus,
    block: optionFromNullable_2(BlockHeader),
});

export { Available as A, Eq as E, Option as O, Predicate as P, Semigroup as S, TxStatus as T, WithdrawalDetails as W, Zero as Z, Ord as a, PayoutHeader as b, PayoutStatus as c, WithdrawalHeader as d, Withdrawn as e, optionFromNullable$2 as o, require$$3 as r };
